    ...
    return (
        <div className="home-container">
            <div className="home-top-container">
                <img className="home-top-image" src={krakenCompPic}></img>
            ...
            <div className="home-image-info-container">
                <img className="home-image-half" src={krakenInstallPic}></img>
