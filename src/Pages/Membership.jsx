    ...
    return (
        <div className="membership_main_container">
            ...
            <Stack gap={2} >
                ...
                <h3 className= "membership_centered_text">HPS at VT accepts students of all techincal disciplines and grade levels. 
                ...
                <a href="https://forms.office.com/r/Lax9BipSMj" target="_blank"> here </a> to access the application. The application closes on 
                Friday, January 26, 2024 at 11:59pm. If you have any questions regarding joining us, please contact us at hps@vt.edu.</h3>
                <h3 className="membership_centered_text"> If the link above does not work here is the full link 
                <a href="https://forms.office.com/r/Lax9BipSMj" target="_blank">https://forms.office.com/r/Lax9BipSMj</a></h3>*/}
            </Stack>
            </div>
