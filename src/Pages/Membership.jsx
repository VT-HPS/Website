    ...
    return (
        <div className="membership_main_container">
            ...
            <Stack gap={2} >
                ...
                <a href="https://forms.office.com/r/G7C4ScQdD3" target="_blank" rel="noreferrer"> here </a> to access the application. The application closes on 
                Friday, September 13, 2024 at 11:59pm. If you have any questions regarding joining us, please contact us at hps@vt.edu.</h3>
                <h3 className="membership_centered_text"> If the link above does not work here is the full link  
                <a href="https://forms.office.com/r/G7C4ScQdD3" target="_blank" rel="noreferrer"> https://forms.office.com/r/G7C4ScQdD3</a></h3>
            </Stack>
            </div>
